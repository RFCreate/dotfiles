...
(gtk_accel_path "<Actions>/win.search.find-and-replace" "<Primary>h")
(gtk_accel_path "<Actions>/win.file.save-all" "<Primary><Alt>s")
(gtk_accel_path "<Actions>/win.edit.duplicate-line-selection" "<Shift><Alt>Down")
...
(gtk_accel_path "<Actions>/win.file.reload" "<Primary>r")
...
(gtk_accel_path "<Actions>/win.help.contents" "")
